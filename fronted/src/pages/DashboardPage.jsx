...
export function DashboardPage() {
    ...
    return (
        <main className="pt-24 pb-12 px-6 md:ml-64 max-w-7xl mx-auto">
            <div className="mb-10">
                <h1 className="font-headline text-4xl font-extrabold tracking-tight text-on-surface">Today's
                    Schedule</h1>
                ...
                <div className="lg:col-span-8 space-y-6">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-4">
                            <span
                                className="font-headline font-bold text-primary tracking-wide text-sm uppercase">Morning</span>
                            <div className="h-[1px] flex-grow bg-outline-variant/20"></div>
                        </div>
                        {morningMeds.map((schedule) => (
                            <div key={schedule.id}
                                 className="bg-surface-container-low p-6 rounded-xl flex items-center justify-between hover:bg-surface-container-lowest transition-all duration-300 group">
                                ...
                                <button
                                    className="bg-primary text-on-primary px-6 py-2.5 rounded-full text-sm font-semibold hover:bg-primary-container transition-all active:scale-95 shadow-sm">
                                    Mark as Taken
                                </button>
                            </div>
                        ))}
                        {morningMeds.length === 0 && (
                            <div
                                className="bg-surface-container-low p-6 rounded-xl text-center text-on-surface-variant">
                    ...
                    <div className="space-y-4 pt-4">
                        <div className="flex items-center gap-4">
                            <span
                                className="font-headline font-bold text-primary tracking-wide text-sm uppercase">Afternoon</span>
                            <div className="h-[1px] flex-grow bg-outline-variant/20"></div>
                        </div>
                        {afternoonMeds.map((schedule) => (
                            <div key={schedule.id}
                                ...
                                <button
                                    className="bg-primary text-on-primary px-6 py-2.5 rounded-full text-sm font-semibold hover:bg-primary-container transition-all active:scale-95">
                                    Mark as Taken
                                </button>
                            </div>
                        ))}
                    ...
                    <div className="space-y-4 pt-4">
                        <div className="flex items-center gap-4">
                            <span
                                className="font-headline font-bold text-primary tracking-wide text-sm uppercase">Evening</span>
                            <div className="h-[1px] flex-grow bg-outline-variant/20"></div>
                        </div>
